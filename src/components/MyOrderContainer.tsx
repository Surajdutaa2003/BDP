...
import bookImage from '../assets/book-image-large-2.png'; // ✅ import image from assets
                            ...
                            <div key={index} className="w-full flex flex-wrap md:flex-nowrap justify-between items-center border border-[#E4E4E4] !mt-3 !p-4">
                                <div className="flex items-center gap-4 w-full md:w-2/3">
                                    <div className="flex justify-center items-center w-[80px] sm:w-[100px]">
                                        <img
                                            src={bookImage} // ✅ use imported image
                                            alt={order.product_id.bookName}
                                            className="w-full h-auto max-w-[80px] sm:max-w-[100px]"
                                        />
                                    </div>
                                    <div className="flex flex-col">
                                        <h2 className="text-lg sm:text-xl text-[#0A0102] mb-1">
                                            {order.product_id.bookName}
                                        </h2>
                                        <p className="text-sm text-[#9D9D9D] mb-2 sm:text-[14px]">
                                            By {order.product_id.author}
                                        </p>
                                        <p className="text-[15px] text-[#0A0102] sm:text-lg font-semibold">
                                ...
                                <div className="flex items-center w-full md:w-1/3 mt-4 md:mt-0 justify-end md:justify-center">
                                    ...
                                    <p className="text-gray-600 text-sm sm:text-base ml-2">
